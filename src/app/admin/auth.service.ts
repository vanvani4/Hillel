...
export class AuthService {
    ...
    isLoggedIn = false; // хранит данные о том авторизованы ли мы в натуре должен быть запрос на сервер, после пробуждения.

    redirectUrl = '/api/admin'; // сюда записываем путь страницы куда мы собирались (admin), куда мы перейдём в случае удачной авторизации.
